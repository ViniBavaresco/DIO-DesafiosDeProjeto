...
var COURSES: Course[] = [
  {
    ...
    description: 'In this course, students will gain a deep understanding of the main features of the CLI.',
    duration: 120,
    code: 'XLF-1212',
    rating: 3,
    price: 12.99,
  ...
  },
  {
    ...
    description: 'In this course, students will gain an in-depth understanding of the resources available on Animation.',
    duration: 80,
    code: 'PWY-9381',
    rating: 5,
    price: 56.99,
